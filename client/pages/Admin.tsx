...
interface PlantStatistics {
  ...
  byToxicity: { 'non-toxic': number; 'mildly-toxic': number; toxic: number; 'highly-toxic': number };
  recentlyAdded: any[];
}
...
export default function Admin() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      if (usersResponse.ok) {
        ...
        const enhancedUsers = usersData.users.map((user: any, index: number) => ({
          ...user,
          permissions: index === 0 ? ["manage_users", "manage_categories", "view_analytics", "system_settings"] : ["view_plants"],
          createdAt: "2024-01-01T00:00:00Z",
          lastLogin: index === 0 ? "2024-01-15T10:30:00Z" : "2024-01-14T15:45:00Z",
  ...
  const handleCreateCategory = async () => {
    try {
      ...
      if (response.ok) {
        setNewCategory({ name: "", description: "", icon: "🌿", color: "bg-green-100 text-green-800" });
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{statistics.totalPlants}</div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{statistics.categoriesCount}</div>
                      <p className="text-xs text-muted-foreground">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Distribution across plant categories</CardDescription>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Plants by care difficulty level</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                          <Pie
                            data={[
                              { name: 'Easy', value: statistics.byDifficulty.easy },
                              { name: 'Moderate', value: statistics.byDifficulty.moderate },
                              { name: 'Challenging', value: statistics.byDifficulty.challenging }
                            ]}
                            cx="50%"
                            cy="50%"
                            labelLine={false}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {statistics.recentlyAdded.slice(0, 5).map((plant, index) => (
          ...
          <TabsContent value="plants" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage plant species, categories, and information</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Plant management features are available. Use the search and filtering system on the Plants page 
                    to find and manage specific species. The comprehensive database now contains {statistics?.totalPlants} plants.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2 pt-4">
                    <Button 
                      onClick={() => handleUpdateUserPermissions(selectedUser.id, userPermissions)}
                    >
                      Save Permissions
                    </Button>
                    <Button 
