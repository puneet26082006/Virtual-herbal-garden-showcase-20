  ...
  const medicinalPlants = [
    {
      ...
      emoji: "🪴",
      uses: ["Skin healing", "Burns treatment", "Digestive health"],
    ...
    },
    {
      ...
      emoji: "🌳",
      uses: ["Memory enhancement", "Circulation"],
      properties: ["Neuroprotective", "Antioxidant"],
      region: "China",
    },
    {
      name: "Ginseng",
      ...
      emoji: "🌿",
      uses: ["Energy enhancement", "Stress adaptation"],
      properties: ["Adaptogenic", "Immunomodulatory"],
    ...
    },
    {
      ...
      emoji: "🌿",
      uses: ["Liver health", "Detoxification"],
    ...
    },
    {
      ...
      properties: ["Adaptogenic", "Anti-stress"],
      region: "India",
    },
    {
      name: "Saw Palmetto",
      ...
      properties: ["Anti-androgenic", "Anti-inflammatory"],
    ...
    },
    {
      ...
      emoji: "🌸",
      uses: ["Fatigue relief", "Mental clarity"],
      properties: ["Adaptogenic", "Neuroprotective"],
    ...
    },
    {
      ...
      emoji: "🌼",
      uses: ["Migraine prevention", "Fever reduction"],
      properties: ["Anti-inflammatory", "Antipyretic"],
      region: "Europe",
    },
    {
      name: "Passionflower",
    ...
    },
    {
      ...
      emoji: "🌼",
      uses: ["Bruise healing", "Pain relief"],
    ...
    },
    {
      ...
      emoji: "🌿",
      uses: ["Immune support", "Infection fighting"],
      properties: ["Antimicrobial", "Immunostimulant"],
      region: "North America",
    },
    {
      name: "Black Cohosh",
      scientific: "Actaea racemosa",
      emoji: "🌿",
      uses: ["Menopause support", "Hormonal balance"],
      properties: ["Phytoestrogenic", "Anti-inflammatory"],
      region: "North America",
    },
    {
      name: "Dandelion",
      ...
      emoji: "🌼",
      uses: ["Liver detox", "Digestive aid"],
    ...
    },
    {
      ...
      emoji: "🌿",
      uses: ["Allergy relief", "Nutrient support"],
      properties: ["Antihistamine", "Nutritive"],
    ...
    },
    {
      ...
      emoji: "🌸",
      uses: ["Menopause support", "Cardiovascular health"],
      properties: ["Phytoestrogenic", "Antioxidant"],
      region: "Europe, Asia",
    },
    {
      name: "Hawthorn",
      ...
      emoji: "🌳",
      uses: ["Heart health", "Circulation"],
      properties: ["Cardiotonic", "Vasodilatory"],
      region: "Europe, Asia, North America",
    },
    {
      name: "Lemon Balm",
      ...
      emoji: "🌿",
      uses: ["Calming", "Digestive aid"],
      properties: ["Sedative", "Carminative"],
      region: "Europe, Asia",
    },
    {
      name: "Plantain",
      ...
      emoji: "🌿",
      uses: ["Wound healing", "Respiratory support"],
      properties: ["Vulnerary", "Expectorant"],
      region: "Europe, Asia",
    },
    {
      name: "Yarrow",
      ...
      emoji: "🌼",
      uses: ["Wound healing", "Fever reduction"],
      properties: ["Vulnerary", "Antipyretic"],
    ...
    },
    {
      ...
      emoji: "🌿",
      uses: ["Immune support", "Cold relief"],
      properties: ["Immunostimulant", "Antiviral"],
    ...
    },
    {
      ...
      emoji: "🌸",
      uses: ["Digestive soothing", "Respiratory support"],
    ...
    },
    {
      ...
      emoji: "🌳",
      uses: ["Digestive soothing", "Throat care"],
      properties: ["Demulcent", "Nutritive"],
      region: "North America",
    },
    {
      name: "Burdock",
      ...
      emoji: "🌿",
      uses: ["Skin health", "Detoxification"],
      properties: ["Depurative", "Anti-inflammatory"],
      region: "Europe, Asia",
    },
    {
      name: "Yellow Dock",
      ...
      emoji: "🌿",
      uses: ["Liver support", "Skin conditions"],
      properties: ["Hepatic", "Depurative"],
      region: "Europe, Asia",
    },
    {
      name: "Cleavers",
      ...
      emoji: "🌿",
      uses: ["Lymphatic support", "Kidney health"],
      properties: ["Lymphatic", "Diuretic"],
      region: "Europe, Asia, North America",
    },
    {
      name: "Mullein",
      ...
      emoji: "🌼",
      uses: ["Respiratory support", "Lung health"],
    ...
    },
    {
      ...
      emoji: "🌿",
      uses: ["Wound healing", "Bone support"],
      properties: ["Vulnerary", "Cell regenerative"],
      region: "Europe, Asia",
    },
    {
      ...
      emoji: "🍃",
      uses: ["Women's health", "Pregnancy support"],
    ...
    },
    {
      ...
      emoji: "🌹",
      uses: ["Vitamin C", "Immune support"],
      properties: ["Nutritive", "Antioxidant"],
      region: "Europe, Asia, North Africa",
    },
    {
      name: "Pine Needles",
      ...
      emoji: "🌲",
      uses: ["Respiratory support", "Vitamin C"],
      properties: ["Expectorant", "Antimicrobial"],
      region: "Europe, Asia",
    },
    {
      name: "Juniper",
      ...
      emoji: "🌲",
      uses: ["Kidney support", "Digestive aid"],
    ...
    },
    {
      ...
      properties: ["Carminative", "Anti-nausea"],
      region: "Southeast Asia",
    },
    {
      name: "Holy Basil",
      ...
      emoji: "🌿",
      uses: ["Stress relief", "Respiratory support"],
      properties: ["Adaptogenic", "Immunomodulatory"],
      region: "India",
    },
    {
      ...
      emoji: "🌿",
      uses: ["Memory enhancement", "Cognitive support"],
      properties: ["Nootropic", "Neuroprotective"],
    ...
    },
    {
      ...
      emoji: "🌿",
      uses: ["Immune support", "Liver health"],
      properties: ["Immunomodulatory", "Hepatoprotective"],
      region: "India",
    },
    {
      name: "Triphala",
    ...
    },
    {
      ...
      emoji: "🌳",
      uses: ["Skin health", "Antimicrobial"],
        ...
        index % 4 === 0
          ...
          : index % 4 === 1
            ...
            : index % 4 === 2
              ...
              : "non-toxic",
      difficulty:
        index % 3 === 0 ? "easy" : index % 3 === 1 ? "moderate" : "challenging",
  ...
  const culinaryPlants = [
    {
      ...
      emoji: "🌿",
      uses: ["Cooking", "Pesto", "Seasoning"],
    },
    {
      name: "Rosemary",
      scientific: "Rosmarinus officinalis",
      emoji: "🌿",
      uses: ["Cooking", "Roasted meats", "Aromatherapy"],
    },
    {
      name: "Thyme",
      scientific: "Thymus vulgaris",
      emoji: "🌿",
      uses: ["Cooking", "Seasoning", "Tea"],
    },
    {
      name: "Oregano",
      scientific: "Origanum vulgare",
      emoji: "🌿",
      uses: ["Pizza", "Italian cuisine", "Seasoning"],
    },
    {
      name: "Sage",
      scientific: "Salvia officinalis",
      emoji: "🌿",
      uses: ["Cooking", "Tea", "Stuffing"],
    },
    {
      name: "Parsley",
      scientific: "Petroselinum crispum",
      emoji: "🌿",
      uses: ["Garnish", "Cooking", "Smoothies"],
    },
    {
      name: "Cilantro",
      scientific: "Coriandrum sativum",
      emoji: "🌿",
      uses: ["Mexican cuisine", "Asian dishes", "Garnish"],
    },
    {
      name: "Dill",
      scientific: "Anethum graveolens",
      emoji: "🌿",
      uses: ["Pickling", "Fish dishes", "Seasoning"],
    },
    {
      name: "Chives",
      scientific: "Allium schoenoprasum",
      emoji: "🌿",
      uses: ["Garnish", "Soups", "Salads"],
    },
    {
      name: "Tarragon",
      scientific: "Artemisia dracunculus",
      emoji: "🌿",
      uses: ["French cuisine", "Vinegar", "Chicken dishes"],
    },
    {
      name: "Marjoram",
      scientific: "Origanum majorana",
      emoji: "🌿",
      uses: ["Meat dishes", "Seasoning", "Tea"],
    },
    {
      name: "Bay Leaves",
      scientific: "Laurus nobilis",
      emoji: "🍃",
      uses: ["Soups", "Stews", "Braising"],
    },
    {
      name: "Fennel",
      scientific: "Foeniculum vulgare",
      emoji: "🌿",
      uses: ["Cooking", "Tea", "Digestive aid"],
    },
    {
      name: "Chervil",
      scientific: "Anthriscus cerefolium",
      emoji: "🌿",
      uses: ["French cuisine", "Eggs", "Delicate dishes"],
    },
    {
      name: "Lovage",
      scientific: "Levisticum officinale",
      emoji: "🌿",
      uses: ["Soups", "Celery substitute", "Seasoning"],
    },
    {
      name: "Summer Savory",
      scientific: "Satureja hortensis",
      emoji: "🌿",
      uses: ["Bean dishes", "Meat", "Seasoning"],
    },
    {
      name: "Winter Savory",
      scientific: "Satureja montana",
      emoji: "🌿",
      uses: ["Heavy dishes", "Preserved meats", "Seasoning"],
    },
    {
      name: "Caraway",
      scientific: "Carum carvi",
      emoji: "🌿",
      uses: ["Bread", "Sauerkraut", "Digestive aid"],
    },
    {
      name: "Cumin",
      scientific: "Cuminum cyminum",
      emoji: "🌿",
      uses: ["Indian cuisine", "Mexican dishes", "Spice blends"],
    },
    {
      name: "Coriander",
      scientific: "Coriandrum sativum",
      emoji: "🌿",
      uses: ["Spice", "Curry", "Baking"],
    },
    {
      name: "Anise",
      scientific: "Pimpinella anisum",
      emoji: "🌿",
      uses: ["Baking", "Liqueurs", "Tea"],
    },
    {
      name: "Star Anise",
      scientific: "Illicium verum",
      emoji: "⭐",
      uses: ["Asian cuisine", "Spice blends", "Tea"],
    },
    {
      name: "Cardamom",
      scientific: "Elettaria cardamomum",
      emoji: "🌿",
      uses: ["Baking", "Coffee", "Indian cuisine"],
    },
    {
      name: "Cloves",
      scientific: "Syzygium aromaticum",
      emoji: "🌿",
      uses: ["Baking", "Mulled wine", "Preservation"],
    },
    {
      name: "Cinnamon",
      scientific: "Cinnamomum verum",
      emoji: "🌿",
      uses: ["Baking", "Desserts", "Tea"],
    },
    {
      name: "Nutmeg",
      scientific: "Myristica fragrans",
      emoji: "🌰",
      uses: ["Baking", "Eggnog", "Savory dishes"],
    },
    {
      name: "Allspice",
      scientific: "Pimenta dioica",
      emoji: "🌿",
      uses: ["Caribbean cuisine", "Baking", "Pickling"],
    },
    {
      name: "Vanilla",
      scientific: "Vanilla planifolia",
      emoji: "🌿",
      uses: ["Desserts", "Baking", "Flavoring"],
    },
    {
      name: "Saffron",
      scientific: "Crocus sativus",
      emoji: "🌼",
      uses: ["Paella", "Luxury dishes", "Coloring"],
    },
    {
      name: "Paprika",
      scientific: "Capsicum annuum",
      emoji: "🌶️",
      uses: ["Seasoning", "Coloring", "Hungarian cuisine"],
    },
    {
      name: "Cayenne",
      scientific: "Capsicum frutescens",
      emoji: "🌶️",
      uses: ["Spicy dishes", "Hot sauce", "Medicine"],
    },
    {
      name: "Black Pepper",
      scientific: "Piper nigrum",
      emoji: "⚫",
      uses: ["Universal spice", "Seasoning", "Preservation"],
    },
    {
      name: "White Pepper",
      scientific: "Piper nigrum",
      emoji: "⚪",
      uses: ["Light-colored dishes", "Asian cuisine", "Seasoning"],
    },
    {
      name: "Pink Peppercorns",
      scientific: "Schinus molle",
      emoji: "🌸",
      uses: ["Gourmet dishes", "Garnish", "Mild spice"],
    },
    {
      name: "Juniper Berries",
      scientific: "Juniperus communis",
      emoji: "🌿",
      uses: ["Gin flavoring", "Game dishes", "Preservation"],
    },
    {
      name: "Mustard Seeds",
      scientific: "Brassica nigra",
      emoji: "🌾",
      uses: ["Condiments", "Pickling", "Indian cuisine"],
    },
    {
      name: "Sesame",
      scientific: "Sesamum indicum",
      emoji: "🌾",
      uses: ["Cooking oil", "Garnish", "Middle Eastern cuisine"],
    },
    {
      name: "Poppy Seeds",
      scientific: "Papaver somniferum",
      emoji: "🌾",
      uses: ["Baking", "European cuisine", "Garnish"],
    },
  ];
